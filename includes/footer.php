<footer style="background:#0f172a;color:rgba(255,255,255,.7);padding:60px 24px 30px;font-family:'Inter',system-ui,sans-serif">
    <div style="max-width:1100px;margin:0 auto;display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:40px">
        <div>
            ...
            <p style="font-size:14px;line-height:1.8;margin-bottom:20px"><?php echo t('footer_tagline'); ?></p>
        ...
        <div>
            <h4 style="color:#fff;font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:16px"><?php echo t('footer_quick'); ?></h4>
            <a href="index.php" style="display:block;color:rgba(255,255,255,.6);text-decoration:none;font-size:14px;padding:4px 0;transition:color .2s"><?php echo t('footer_browse'); ?></a>
            <a href="<?php echo isset($_SESSION['user_id']) ? 'post_house.php' : 'register.php'; ?>" style="display:block;color:rgba(255,255,255,.6);text-decoration:none;font-size:14px;padding:4px 0;transition:color .2s"><?php echo t('btn_list_property'); ?></a>
            <a href="login.php" style="display:block;color:rgba(255,255,255,.6);text-decoration:none;font-size:14px;padding:4px 0;transition:color .2s"><?php echo t('footer_signin'); ?></a>
        </div>
        <div>
            <h4 style="color:#fff;font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:16px"><?php echo t('footer_categories'); ?></h4>
            <a href="index.php?cat=Single+Home" style="display:block;color:rgba(255,255,255,.6);text-decoration:none;font-size:14px;padding:4px 0"><?php echo t('cat_single'); ?></a>
            <a href="index.php?cat=Apartment" style="display:block;color:rgba(255,255,255,.6);text-decoration:none;font-size:14px;padding:4px 0"><?php echo t('footer_apartments'); ?></a>
            <a href="index.php?cat=Villa" style="display:block;color:rgba(255,255,255,.6);text-decoration:none;font-size:14px;padding:4px 0"><?php echo t('footer_villas'); ?></a>
            <a href="index.php?cat=Shop" style="display:block;color:rgba(255,255,255,.6);text-decoration:none;font-size:14px;padding:4px 0"><?php echo t('footer_shops'); ?></a>
        </div>
        <div>
            <h4 style="color:#fff;font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:16px"><?php echo t('footer_contact'); ?></h4>
